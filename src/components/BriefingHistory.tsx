...
export default function BriefingHistory({ onSelect }: BriefingHistoryProps) {
  ...
  return (
    <div className="animate-fade-in">
      <h3 className="text-xs uppercase tracking-widest text-white/40 font-body font-semibold mb-6">
      ...
      <div className="grid gap-3">
        {briefings.map((b) => (
          <button
            ...
            className="w-full text-left p-5 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-gold/20 hover:bg-white/[0.04] transition-all group"
          >
